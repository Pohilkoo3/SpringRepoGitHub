                    ...
                    $('[data-refreshshow]').on('click change', function (e) {
                        ...
                        switch (data) {
                            ...
                            case'recent':
                                ...
                                break;
                            case'popular':
                                getData('/books/nextPage/popular', {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                            ...
                            case'genre':
                                ...
                                break;
                            case'author':
                                getData('/books/page/author/' + $this.data('refreshid'), {
                                    offset: function () {
                                        var oldOffset = $this.data('refreshoffset');
                                        if(oldOffset < 1){
                                            $this.data('refreshoffset', ++oldOffset);
                                    ...
                                    if ($(slick.$slider).data('load')) {
                                        ...
                                        switch ($(slick.$slider).data('load')) {
                                            case'recommended':
                                                ...
                                                break;
                                            case'recent':
                                                sendData('/books/page/recent')
                                                break;
                                            case'popular':
                                                sendData('/books/page/popular')
                                                break;
                                        }
                                    }
                                }
